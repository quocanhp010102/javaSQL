 ...
 * @author PC
 */
public class TransactionsRevenueFrame extends javax.swing.JFrame {

    /**
     * Creates new form TransactionsRevenueFrame
     */
    public TransactionsRevenueFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransactionsRevenueFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransactionsRevenueFrame().setVisible(true);
            }
        });
    }
